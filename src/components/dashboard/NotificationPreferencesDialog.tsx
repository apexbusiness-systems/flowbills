          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="help_articles" className="flex flex-col gap-1 cursor-pointer">
                ...
                <span className="text-xs text-muted-foreground">New documentation and guides</span>
              </Label>
              <Switch
                id="help_articles"
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="feature_updates" className="flex flex-col gap-1 cursor-pointer">
                ...
                <span className="text-xs text-muted-foreground">New features and improvements</span>
              </Label>
              <Switch
                id="feature_updates"
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => setLocalPrefs({ ...localPrefs, tips: checked })}
              />
            </div>
