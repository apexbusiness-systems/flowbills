            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateConfig("min_amount", parseFloat(e.target.value) || undefined)
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateConfig("max_amount", parseFloat(e.target.value) || undefined)
                  }
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateConfig("max_days_old", parseInt(e.target.value) || undefined)
                }
              />
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                {["invoice_number", "vendor_name", "amount", "invoice_date"].map((field) => (
                  <label key={field} className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      checked={(formData.rule_config.check_fields || ["invoice_number"]).includes(
                        field
                      )}
                      onChange={(e) => {
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Example: ^INV-\d{4}-\d{3}$ for INV-2024-001
              </p>
            </div>
            <div>
      ...
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-2 justify-end pt-4 border-t">
            ...
            <Button type="submit" disabled={!formData.rule_name || !formData.rule_type}>
              Create Rule
            </Button>
          </div>
        </form>
