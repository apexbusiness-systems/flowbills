...
const INVOICE_TOUR_STEPS = [
  {
    ...
    content:
      "Let's take a quick tour of the invoice processing workflow. This will only take 2 minutes.",
  ...
  },
  {
    ...
    content:
      "Start by uploading your invoice documents here. We support PDF, images, and common document formats.",
  ...
  },
  {
    ...
    content:
      "Stay updated with real-time activity feed showing recent invoice actions and system events.",
  ...
  },
  {
    ...
    content:
      "Manage Authorization for Expenditure (AFE) budgets and track spending against approved amounts.",
    placement: "bottom" as const,
  },
  {
    id: "field-tickets",
  ...
  },
  {
    ...
    content:
      "Leverage three-way matching to automatically verify invoices against POs and field tickets.",
  ...
  },
  {
    ...
    content:
      "Press ⌘K (Ctrl+K on Windows) anytime to quickly navigate, search, and perform actions without using the mouse.",
    placement: "bottom" as const,
  },
];
