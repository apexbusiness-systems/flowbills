...
const readinessData: ReadinessScore[] = [
  {
    ...
    recommendations: ["Monitor for XRechnung updates", "Prepare for issuance phases (2025-2028)"],
  },
  {
    country: "Poland",
    code: "PL",
    ...
    <div className="space-y-6">
      ...
      <Alert
        className={getStatusColor(
          overallReadiness >= 90 ? "ready" : overallReadiness >= 60 ? "warning" : "urgent"
        )}
      >
          ...
          <Card key={item.code} className="relative">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Progress value={item.score} className="h-2" color={getProgressColor(item.score)} />
              </div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium">
                  {formatDaysUntilDeadline(item.daysUntilDeadline)}
                </span>
              </div>
