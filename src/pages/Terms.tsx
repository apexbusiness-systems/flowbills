      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            These terms govern your use of FlowBills.ca services, including CASL compliance
            requirements for electronic communications and commercial messaging.
          </p>
        ...
        <Card className="mb-8 border-primary/20">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              By using FlowBills.ca services, you consent to receive commercial electronic messages
              from us. All communications include sender identification, contact information, and
              unsubscribe mechanisms as required by Canada's Anti-Spam Legislation (CASL).
            </p>
          </CardContent>
        </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    By accessing or using FlowBills.ca ("Service"), operated by FlowBills.ca
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    Service. By accessing the Service, you represent that you are at least 18 years
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      FlowBills.ca is intended for business use. You represent that you have the
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      By creating an account or subscribing to our services, you provide express
                      consent to receive commercial electronic messages (CEMs) from FlowBills.ca,
                      including:
                    </p>
                    <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      All electronic communications will clearly identify FlowBills.ca as the sender
                      and include our contact information as required by CASL.
                    </p>
                  </div>
                  <div>
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Even if you unsubscribe from marketing communications, you will continue to
                      receive essential service-related messages necessary for your use of
                      FlowBills.ca.
                    </p>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                      ...
                      <li>
                        To violate any international, federal, provincial, or local regulations or
                        laws
                      </li>
                      <li>
                      ...
                      <li>
                        To impersonate or attempt to impersonate the Company, employees, or other
                        users
                      </li>
                      <li>
                        To engage in any other conduct that restricts or inhibits anyone's use of
                        the Service
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                      ...
                      <li>
                        Use any automated system to access the Service in a manner that sends more
                        requests than a human can produce
                      </li>
                      <li>
                        Introduce any viruses, trojan horses, worms, logic bombs, or other malicious
                        material
                      </li>
                      <li>
                        Attempt to interfere with, compromise, or reverse engineer any Service
                        components
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      You may only upload and process data that you own or have explicit permission
                      to use. You are responsible for ensuring your data complies with applicable
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      We process your data in accordance with our Privacy Policy and applicable
                      Canadian privacy laws, including PIPEDA. By using the Service, you consent to
                      such processing.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      ownership of any content you submit, upload, or display on or through the
                      Service.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      data, but cannot guarantee absolute security. See our Security page for
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      remain the exclusive property of FlowBills.ca and its licensors. The Service
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      You grant us a limited, non-exclusive, transferable license to use your
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      FlowBills.ca and related marks are trademarks of FlowBills.ca. You may not use
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      warranties, expressed or implied, regarding the Service's availability,
                      reliability, or suitability for your particular use.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Limitation of Damages</h4>
                    <p className="text-sm text-muted-foreground">
                      In no event shall FlowBills.ca, its directors, employees, partners, agents,
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Our total liability to you for all damages shall not exceed the amount paid by
                      you to FlowBills.ca in the twelve (12) months preceding the claim.
                    </p>
                  </div>
                  <div className="bg-muted/50 p-4 rounded-lg">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      account closure feature in your dashboard. Termination will be effective
                      immediately.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Upon termination, your right to use the Service will cease immediately. We
                      will retain your data for 30 days to allow for account recovery, after which
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      These Terms shall be interpreted and governed by the laws of the Province of
                      Alberta and the federal laws of Canada applicable therein, without regard to
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      cannot be resolved informally, we agree to binding arbitration under the
              ...
              <Card className="border-primary/20">
                ...
                <CardContent>
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <div>
                      <strong>Email:</strong> legal@flowbills.ca
                    </div>
                    <div>
                      <strong>Phone:</strong> 1-844-FLOWBILL
                    </div>
                    <div>
                      <strong>Address:</strong> Edmonton, AB, Canada
                    </div>
                  </div>
